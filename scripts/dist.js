...
// Minify JS
;(async () => {
  await minifyJs(path.join(src, "scripts/index.js"), path.join(dist, "scripts/index.js"))
  await minifyJs(path.join(src, "scripts/background.js"), path.join(dist, "scripts/background.js"))
